...
dbig = interval(big(70.0)) 
 ...
 fourier0 = CosFourier(N0, π/dbig)⊗CosFourier(N0, π/dbig)
 fourier = CosFourier(N, π/dbig)⊗CosFourier(N, π/dbig)

#  W = load("Wc_028_70_130.jld2","W")
...
#  U = W - (Li.*C)*solve(Matrix(prod_130),vec(S*W))
#  display("U created")
...
#  U2 = U*U
#  jldsave("Wc_028_70_130_projected.jld2" ; U)
#  jldsave("Wc_028_70_130_square.jld2" ; U2)

#
 U = load("Wc_028_70_130_projected.jld2","U")
...
final_q_square = qq
jldsave("final_q_square.jld2" ; final_q_square)
